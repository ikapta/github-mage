<template>
  <div v-loading="loading">
    <el-table ref="multipleTable" :data="nfcsData" border tooltip-effect="dark" style="width: 100%" @selection-change="handleSelectionChange">
  ...
  export default {
    ...
    methods: {
      async getNotifications () {
        this.loading = true
        this.nfcsData = await GithubService.listNotifications()
        this.loading = false
      },
